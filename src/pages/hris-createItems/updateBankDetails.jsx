...
function handleSubmit(e) {
    e.preventDefault();
    axios.put('https://kwale-hris-app.onrender.com:4000/updateBankDetails/'+prollId,{bankAccountName,bankAccountNumber,bankBranch,payrollId,nssfNumber,nhifNumber})
    .then(res=>{
        console.log(res);
        navigate('/employees');
    }).catch(err=>console.log(err));
